...
describe('getElementsByClassName', function(){
  ...
  it('should match the results of calling the built-in function', function(){
    ...
    htmlStrings.forEach(function(htmlString){
      ...
      var result = getElementsByClassName('targetClassName'); console.log(result)
      var expectedNodeList = document.getElementsByClassName('targetClassName'); console.log(expectedNodeList)
      var expectedArray = Array.prototype.slice.apply(expectedNodeList); console.log(expectedArray);
